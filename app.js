...
function displayNumber(input) {
  ...
  if (input.length == 1){
    ...
    containers.push("#first-container","#second-container","#third-container");
  }
...
function numberOnSevenSgment(digit, degreeOfNumber) {
  var arrayOfsegments=[];
  switch (digit) {
    case '0': arrayOfsegments.push('.a','.b','.c','.d','.e','.f');
      break;
    case '1': arrayOfsegments.push('.c','.b');
      break;
    case '2': arrayOfsegments.push('.a','.b','.d','.e','.g-lower','.g-upper');
      break;
    case '3': arrayOfsegments.push('.a','.b','.c','.d','.g-lower','.g-upper');
      break;
    case '4': arrayOfsegments.push('.b','.c','.f','.g-lower','.g-upper');
      break;
    case '5': arrayOfsegments.push('.a','.c','.d','.f','.g-lower','.g-upper');
      break;
    case '6': arrayOfsegments.push('.a','.c','.d','.e','.f','.g-lower','.g-upper');
      break;
    case '7': arrayOfsegments.push('.a','.b','.c');
      break;
    case '8': arrayOfsegments.push('.a','.b','.c','.d','.e','.f','.g-lower','.g-upper');
      break;
    case '9': arrayOfsegments.push('.a','.b','.c','.d','.f','.g-lower','.g-upper');
      break;
      default: break;
  }
